...
A small, complete example of a Java application built with Maven, unit tested with JUnit 5, and built automatically by a Jenkins pipeline. 
Use it as a starting point for learning Jenkins CI/CD with Java, or as a portfolio project.
